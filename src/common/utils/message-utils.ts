...
export function formatConversationForFrontend(conversation: Conversation, currentUserId: string): any {
...
export function formatMessageForFrontend(message: Message, currentUserId: string): any {
  return {
